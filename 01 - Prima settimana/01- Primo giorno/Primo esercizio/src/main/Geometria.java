...
public class Geometria 
{
	public static void main(String[] args) 
	{
		...
		output1 = "L'area del quadrato di lato " + latoQuadrato + " è: " + areaQuadrato;
		...
		output2 = "L'area del rettangolo di base " + baseRettangolo + " e altezza " + altezzaRettangolo + " è: " + areaRettangolo;
		...
		output4 = "L'area del cerchio di raggio " + raggioCerchio +" è: " + areaCerchio;
